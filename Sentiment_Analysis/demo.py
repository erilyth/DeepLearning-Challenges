...
trainX, testX, trainY, testY = train_test_split(totalX, totalY, test_size=0.05)
...
model.fit(trainX, trainY, validation_set=(testX, testY), show_metric=True, batch_size=64, n_epoch=50)
